...
export default function PricingPlan() {
  return (
    <>
      ...
      <section className=" w-full bg-[#F5F8ED] ">
        <div className="mx-auto flex flex-col justify-center  gap-14  px-4 py-28 w-full max-w-screen-xl">
          <div className="flex flex-col gap-6">
            <div className="w-full flex justify-center text-center text-app_primary items-center gap-2 ">
              <svg
                stroke="currentColor"
                fill="currentColor"
                stroke-width="0"
            ...
            <div className=" flex w-full md:text-center justify-center ">
              <h2 className="   px-4 max-w-screen-sm mx-auto w-full font-AlbertSans font-semibold text-[22px] leading-8 sm:text-[38px] sm:leading-[48px] md:text-[44px] md:leading-[54px] lg:text-[32px] lg:leading-[42px] xl:text-[40px] xl:leading-[50px] 2xl:text-[46px] 2xl:leading-[56px] text-HeadingColor-0 ">
                A Customizable Approach for Your Business
              </h2>
            </div>
          </div>
          ...
          <div className=" grid grid-cols-l sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {PriceCards.map((Card, index) => (
              <PriceCard key={index} plan={Card.plan} price={Card.price} />
            ))}
          </div>
        </div>
      </section>
        ...
        <section
            ...
            >
              ...
              <div className=" left-1/3 top-10  absolute w-40 h-20 animate-[bounce_2s_infinite]">
              <Image 
